...
class TikStartScreen extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => _TikStartScreenState();
}

class _TikStartScreenState extends State<TikStartScreen> {
